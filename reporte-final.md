...
|---------|-------|-------|-----------------------------|
| AV1 | 26/04/2026 | <br> Alfaro Mallma, Alberto Joaquin <br> <br> Vilchez Vite, Gabriel Alejandro <br> <br> Quispe Perez, Eder Edu <br> <br> Rodriguez Rojas, Miler Alexander <br> <br> Verastigue Martinez, Giancarlo Jose <br> |- Carátula <br> - Registro de Versiones del Informe <br> - Project Report Collaboration Insights <br> - Contenido <br> - Student Outcome <br> - Capítulo I: Introducción <br> - Capítulo II: Requirements Elicitation & Analysis. <br> - Capítulo III: Requirements Specification. <br>  - Capítulo IV: Product Design. <br> - Capítulo V: Product Implementation, Validation & Deployment. Hasta el punto 5.2.1.8 <br> - Primera version de landing page implementada y desplegada. |
...
|---|---|---|
| Las agencias de turismo de aventura del Perú carecen de herramientas accesibles para monitorear en tiempo real la ubicación y el estado de salud de sus clientes en zonas remotas con baja o nula conectividad celular. Esto genera ceguera operativa, tiempos de respuesta lentos ante emergencias médicas y extravíos, y expone a las agencias a riesgos legales y reputacionales. Los turistas, por su parte, no cuentan con herramientas de navegación funcionales sin señal, lo que incrementa su ansiedad y reduce su autonomía durante el recorrido. | - Plataforma web con dashboard centralizado para monitoreo de múltiples grupos en tiempo cuasi-real y alertas automatizadas ante anomalías. <br><br> - Wearables IoT de bajo costo para captura continua de signos vitales y geolocalización. <br><br> - Checkpoints Bluetooth para sincronización asincrónica de datos sin necesidad de cobertura celular. <br><br> - Aplicación móvil para turistas con mapas topográficos interactivos y navegación 100% offline. <br><br> - Generación automática de resumen digital de la experiencia del recorrido al finalizar el tour. | - Reducción del 40% en evacuaciones médicas de emergencia en los primeros 6 meses de uso. <br><br> - Registro exitoso del 95% de turistas en puntos de control con pérdida de datos inferior al 5%. <br><br> - Tasa de conversión del 25% de agencias de piloto gratuito a suscripción anual en 3 meses. <br><br> - El 85% de turistas califica su sensación de seguridad como "Alta" o "Muy Alta" en encuestas post-tour. |

| 3. Users & Customers | 4. User Outcomes & Benefits |
|---|---|
| *B2B (Operativo):* Agencias de turismo de aventura, directores de ruta y guías de montaña que gestionan expediciones en zonas remotas del Perú. <br><br> *B2C (Usuario Final):* Turistas nacionales e internacionales, senderistas y exploradores que contratan estos servicios y transitan por rutas de baja o nula conectividad. | - Respuesta inmediata ante emergencias de salud como taquicardia, hipotermia o fatiga extrema gracias a alertas preventivas. <br><br> - Navegación segura y autónoma sin dependencia de red móvil mediante mapas offline. <br><br> - Registro digital interactivo de la experiencia del recorrido compartible en redes sociales. <br><br> - Reducción de costos logísticos en misiones de búsqueda y rescate. <br><br> - Escalabilidad en la gestión simultánea de múltiples rutas y grupos desde un solo dashboard. |
...
|---|---|---|
| - El monitoreo biométrico continuo mediante wearables permitirá reducir en un 40% las evacuaciones de emergencia. <br><br> - La sincronización asincrónica BLE garantizará trazabilidad del 95% de turistas sin cobertura celular. <br><br> - La navegación offline reducirá la ansiedad del turista y logrará que el 85% califique su seguridad como alta. <br><br> - Los dashboards centralizados reducirán el tiempo de respuesta ante alertas a menos de 5 minutos. <br><br> - El modelo híbrido HaaS/SaaS logrará una conversión del 25% de pilotos a suscripciones pagadas en 3 meses. | ¿Es la precisión y latencia de los datos capturados por los wearables y sincronizados mediante checkpoints Bluetooth suficiente para activar alertas de rescate confiables en entornos de clima extremo y geografía compleja? | Desarrollar un MVP consistente en un wearable básico conectado a un checkpoint BLE, y realizar una prueba de campo en una ruta de senderismo conocida con 5 usuarios reales, midiendo la latencia de sincronización de datos y la tasa de pérdida de paquetes bajo condiciones climáticas variables. |
...
| Dimensión | Categoría | <img src="assets/images/logo-vitaltrek.png" width="80"/><br>**VitalTrek (Nexum Devs)** | <img src="assets/images/logo-trekksoft.png" width="80"/><br>**TrekkSoft** | <img src="assets/images/logo-wayward.png" width="80"/><br>**Wayward** | <img src="assets/images/logo-alltrails.png" width="80"/><br>**AllTrails** |
|---|---|---|---|---|---|
...
| US14 | Desasignar turista de un tour | Como administrador de agencia, quiero desasignar a un turista de un tour para actualizar la composición del grupo. | **Escenario 1: Desasignación exitosa**<br>Given que el administrador de agencia selecciona un turista asignado a un tour<br>When envía la solicitud de desasignación<br>Then el sistema retira al turista del tour y retorna confirmación<br><br>**Escenario 2: Expedición ya iniciada**<br>Given que el administrador de agencia intenta desasignar a un turista de un tour cuya expedición se encuentra en curso<br>When envía la solicitud de desasignación<br>Then el sistema requiere confirmación adicional antes de procesar la solicitud<br><br>**Escenario 3: Turista no asignado al tour**<br>Given que el turista seleccionado no pertenece al tour indicado<br>When el administrador de agencia envía la solicitud de desasignación<br>Then el sistema retorna un error indicando que el turista no está asignado a ese tour | EP02 |
| US15 | Confirmar asistencia | Como turista, quiero confirmar mi asistencia a un tour para asegurar mi participación en el recorrido. | **Escenario 1: Confirmación exitosa**<br>Given que el turista está asignado a un tour disponible<br>When envía la solicitud de confirmación de asistencia<br>Then el sistema actualiza el estado de participación correctamente<br><br>**Escenario 2: Cancelación de participación**<br>Given que el turista ha confirmado previamente su asistencia<br>When envía la solicitud de cancelación<br>Then el sistema actualiza el estado de participación y notifica al administrador de agencia<br><br>**Escenario 3: Expedición ya iniciada**<br>Given que la expedición del tour al que pertenece el turista ya ha comenzado<br>When el turista envía la solicitud de cancelación<br>Then el sistema retorna un error indicando que no es posible modificar la participación | EP02 |
| US16 | Buscar y filtrar tours | Como turista, quiero buscar y filtrar los tours disponibles para encontrar opciones acordes a mis intereses y preferencias. | **Escenario 1: Búsqueda con resultados**<br>Given que el turista proporciona un término de búsqueda válido<br>When el sistema procesa la consulta<br>Then el sistema retorna los tours cuya información coincide con el término ingresado<br><br>**Escenario 2: Filtro con resultados**<br>Given que el turista aplica criterios de filtrado válidos<br>When el sistema procesa la consulta<br>Then el sistema retorna los tours que cumplen los criterios indicados<br><br>**Escenario 3: Búsqueda sin coincidencias**<br>Given que el término o criterios proporcionados no coinciden con ningún tour disponible<br>When el sistema procesa la consulta<br>Then el sistema retorna una respuesta vacía indicando que no hay coincidencias | EP02 |
| US17 | Consultar detalle del tour | Como turista, quiero acceder a la información completa de un tour para tomar una decisión informada antes de participar. | **Escenario 1: Consulta exitosa**<br>Given que el tour solicitado existe en el sistema<br>When el turista solicita el detalle<br>Then el sistema retorna la información completa del recorrido incluyendo ruta, checkpoints y dificultad<br><br>**Escenario 2: Tour no encontrado**<br>Given que el tour solicitado no existe en el sistema<br>When el turista solicita el detalle<br>Then el sistema retorna un error indicando que el recurso no existe<br><br>**Escenario 3: Consulta de turistas asignados**<br>Given que el administrador de agencia solicita la lista de turistas de un tour existente<br>When el sistema procesa la solicitud<br>Then el sistema retorna los datos relevantes de cada turista asignado junto con su estado de confirmación | EP02 |
| US18 | Consultar tours de la agencia | Como administrador de agencia, quiero consultar todos los tours registrados por mi agencia para gestionarlos de forma centralizada. | **Escenario 1: Consulta con resultados**<br>Given que la agencia tiene tours registrados en el sistema<br>When el administrador de agencia solicita la consulta<br>Then el sistema retorna el listado completo de tours con su estado actual<br><br>**Escenario 2: Filtro por estado**<br>Given que el administrador de agencia aplica un filtro por estado del tour<br>When el sistema procesa la consulta<br>Then el sistema retorna únicamente los tours que coinciden con el estado indicado<br><br>**Escenario 3: Sin tours registrados**<br>Given que la agencia no tiene tours registrados<br>When el administrador de agencia solicita la consulta<br>Then el sistema retorna una respuesta vacía indicando la ausencia de tours | EP02 |
...
| US39 | Actualizar foto de perfil | Como usuario registrado, quiero actualizar mi foto de perfil para personalizar mi cuenta en la plataforma. | **Escenario 1: Actualización exitosa**<br>Given que el usuario proporciona un archivo de imagen con formato y tamaño válidos<br>When envía la solicitud de actualización<br>Then el sistema almacena la imagen y la asocia al perfil del usuario<br><br>**Escenario 2: Formato de archivo inválido**<br>Given que el usuario proporciona un archivo con extensión no soportada<br>When envía la solicitud de actualización<br>Then el sistema retorna un error indicando los formatos de imagen aceptados<br><br>**Escenario 3: Tamaño de archivo excedido**<br>Given que el archivo proporcionado supera el tamaño máximo permitido<br>When el sistema procesa la solicitud<br>Then el sistema retorna un error indicando el límite de tamaño permitido | EP05 |
| US40 | Configurar preferencias de notificaciones | Como usuario registrado, quiero configurar las preferencias de notificaciones para recibir únicamente las que considero relevantes. | **Escenario 1: Configuración exitosa**<br>Given que el usuario proporciona preferencias válidas<br>When envía la solicitud de configuración<br>Then el sistema aplica las preferencias y retorna confirmación<br><br>**Escenario 2: Restaurar preferencias por defecto**<br>Given que el usuario solicita restablecer las preferencias a los valores predeterminados<br>When el sistema procesa la solicitud<br>Then el sistema aplica la configuración por defecto y retorna confirmación<br><br>**Escenario 3: Configuración inválida**<br>Given que el usuario proporciona preferencias con formato incorrecto<br>When envía la solicitud de configuración<br>Then el sistema retorna un error indicando los parámetros inválidos | EP05 |
| US41 | Recibir notificaciones de seguridad | Como usuario registrado, quiero recibir notificaciones de alerta de seguridad para mantenerme informado sobre eventos críticos relacionados con mi expedición. | **Escenario 1: Notificación generada por alerta**<br>Given que el sistema detecta una condición crítica asociada a la expedición del usuario<br>When procesa el evento de seguridad<br>Then el sistema genera y envía la notificación al usuario correspondiente a través del canal configurado<br><br>**Escenario 2: Notificaciones de seguridad deshabilitadas**<br>Given que el usuario tiene deshabilitadas las notificaciones de alerta en su configuración<br>When ocurre un evento de seguridad que generaría una notificación<br>Then el sistema no envía la notificación y registra el evento internamente<br><br>**Escenario 3: Canal de notificación no disponible**<br>Given que el canal de notificación configurado no está disponible en el momento del evento<br>When el sistema intenta enviar la notificación<br>Then el sistema reintenta el envío por un canal alternativo y registra el intento fallido | EP05 |
| US42 | Recibir notificaciones de tour | Como turista, quiero recibir notificaciones sobre actualizaciones de mi tour para mantenerme informado sobre cambios en mi participación. | **Escenario 1: Notificación de asignación**<br>Given que el turista es asignado a un tour por el administrador de agencia<br>When el sistema procesa la asignación<br>Then el sistema envía una notificación al turista informando sobre su nueva asignación<br><br>**Escenario 2: Notificación de inicio de expedición**<br>Given que la expedición a la que pertenece el turista es iniciada por el guía<br>When el sistema registra el inicio<br>Then el sistema envía una notificación al turista indicando que la expedición ha comenzado<br><br>**Escenario 3: Notificación de cancelación**<br>Given que el tour al que pertenece el turista es cancelado por el administrador de agencia<br>When el sistema registra la cancelación<br>Then el sistema envía una notificación al turista informando sobre la cancelación del tour | EP05 |
| US43 | Consultar historial de notificaciones | Como usuario registrado, quiero consultar el historial de notificaciones recibidas para revisar eventos pasados relacionados con mi cuenta. | **Escenario 1: Consulta con resultados**<br>Given que el usuario tiene notificaciones registradas en el sistema<br>When solicita el historial de notificaciones<br>Then el sistema retorna el listado de notificaciones ordenadas cronológicamente<br><br>**Escenario 2: Marcar notificación como leída**<br>Given que el usuario selecciona una notificación no leída<br>When envía la solicitud de marcado<br>Then el sistema actualiza el estado de la notificación a leída y retorna confirmación<br><br>**Escenario 3: Sin notificaciones registradas**<br>Given que el usuario no tiene notificaciones en el sistema<br>When solicita el historial<br>Then el sistema retorna una respuesta vacía indicando la ausencia de notificaciones | EP05 |
...
| US-LP01 | Conocer la propuesta de valor | Como visitante, quiero conocer la propuesta de valor de VitalTrek para evaluar si la plataforma se ajusta a mis necesidades. | **Escenario 1: Contenido principal disponible**<br>Given que el visitante accede a la landing page<br>When el sistema entrega el contenido principal<br>Then el sistema retorna la información que comunica el propósito y el beneficio central de la plataforma<br><br>**Escenario 2: Acceso desde dispositivo móvil**<br>Given que el visitante accede a la landing page desde un dispositivo móvil<br>When el sistema procesa la solicitud<br>Then el sistema entrega el contenido adaptado al tamaño del dispositivo<br><br>**Escenario 3: Contenido no disponible**<br>Given que ocurre un fallo al entregar el contenido principal<br>When el visitante accede a la landing page<br>Then el sistema retorna un mensaje indicando que el contenido no está disponible temporalmente | EP06 |
| US-LP02 | Navegar entre secciones | Como visitante, quiero acceder a las distintas secciones de la landing page para conocer las funcionalidades del sistema. | **Escenario 1: Navegación exitosa**<br>Given que el visitante accede a la landing page<br>When solicita acceder a una sección específica<br>Then el sistema redirige al contenido correspondiente a la sección seleccionada<br><br>**Escenario 2: Acceso desde dispositivo móvil**<br>Given que el visitante accede desde un dispositivo móvil<br>When solicita acceder a una sección<br>Then el sistema entrega el contenido adaptado al tamaño del dispositivo<br><br>**Escenario 3: Sección no disponible**<br>Given que el visitante solicita una sección que no se encuentra disponible<br>When el sistema procesa la solicitud<br>Then el sistema retorna un mensaje indicando que la sección no está disponible temporalmente | EP06 |
...
| US-LP08 | Contactar al equipo de VitalTrek | Como visitante, quiero contactar al equipo de VitalTrek para resolver dudas relacionadas con la plataforma. | **Escenario 1: Mensaje enviado correctamente**<br>Given que el visitante proporciona información válida en el formulario de contacto<br>When envía la solicitud de contacto<br>Then el sistema registra el mensaje correctamente y retorna confirmación de recepción<br><br>**Escenario 2: Datos inválidos**<br>Given que el visitante ingresa información con formato incorrecto<br>When envía la solicitud de contacto<br>Then el sistema retorna un error indicando los campos con formato inválido<br><br>**Escenario 3: Servicio de contacto no disponible**<br>Given que el servicio de contacto no se encuentra disponible<br>When el visitante envía la solicitud<br>Then el sistema retorna un mensaje indicando que el servicio no está disponible temporalmente | EP06 |
| US-LP09 | Conocer al equipo de la startup | Como visitante, quiero conocer al equipo detrás de VitalTrek para construir confianza en la propuesta de valor. | **Escenario 1: Información del equipo disponible**<br>Given que el visitante solicita el contenido del equipo<br>When el sistema procesa la solicitud<br>Then el sistema retorna información sobre los miembros del equipo de NexumDevs<br><br>**Escenario 2: Acceso desde dispositivo móvil**<br>Given que el visitante accede al contenido del equipo desde un dispositivo móvil<br>When el sistema procesa la solicitud<br>Then el sistema retorna la información adaptada al tamaño del dispositivo<br><br>**Escenario 3: Contenido no disponible**<br>Given que ocurre un fallo al entregar el contenido del equipo<br>When el visitante solicita el contenido<br>Then el sistema retorna un mensaje indicando que el contenido no está disponible temporalmente | EP06 |
| US-LP10 | Acceder a una demostración del sistema | Como visitante, quiero acceder a una demostración del sistema para comprender el funcionamiento de la plataforma antes de registrarme. | **Escenario 1: Demostración disponible**<br>Given que el visitante solicita la demostración del sistema<br>When el sistema procesa la solicitud<br>Then el sistema provee acceso al recurso de demostración correctamente<br><br>**Escenario 2: Interacción con la demostración**<br>Given que el visitante interactúa con la demostración<br>When el sistema procesa cada interacción<br>Then el sistema responde correctamente a cada acción del visitante<br><br>**Escenario 3: Demostración no disponible**<br>Given que el recurso de demostración no se encuentra disponible<br>When el visitante solicita la demostración<br>Then el sistema retorna un mensaje indicando que el recurso no está disponible temporalmente | EP06 |
...
<br>**User Goal 1:** Monitoreo de grupos turísticos
