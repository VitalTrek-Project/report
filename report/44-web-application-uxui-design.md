...
![Wireflow 01 - Marco registra su cuenta](assets/wireflow-01-registro.png)
...
![Wireflow 02 - Marco se inscribe en una ruta](assets/wireflow-02-inscripcion-ruta.png)
...
![Wireflow 03 - Marco sigue su expedición](assets/wireflow-03-expedicion-tiempo-real.png)
...
![Wireflow 04 - Ana Lucía monitorea turistas](assets/wireflow-04-monitoreo-turistas.png)
...
![Wireflow 05 - Ana Lucía crea un tour](assets/wireflow-05-creacion-tour.png)
...
![Wireflow 06 - Ana Lucía gestiona permisos](assets/wireflow-06-gestion-permisos.png)
...
**Módulo de entrada y acceso:**

![Mock-up - Login](assets/mockup-01-login.png)

![Mock-up - Create account](assets/mockup-02-create-account.png)

**Módulo del turista aventurero (Marco Rodriguez):**

![Mock-up - Hero / landing](assets/mockup-03-hero.png)

![Mock-up - Plans and prices](assets/mockup-04-plans-prices.png)

![Mock-up - Explore routes](assets/mockup-05-explore-routes.png)

![Mock-up - Navigation and expedition](assets/mockup-06-navigation.png)

![Mock-up - Community](assets/mockup-07-community.png)

![Mock-up - My profile](assets/mockup-13-my-profile.png)

**Módulo de gestión operativa (Ana Lucía Quispe):**

![Mock-up - Tour management](assets/mockup-08-tour-management.png)

![Mock-up - Security and monitoring](assets/mockup-09-security-monitoring.png)

![Mock-up - Agencies](assets/mockup-10-agencies.png)

![Mock-up - Identity and access](assets/mockup-11-identity-access.png)

**Módulo transversal:**

![Mock-up - Notifications and profile](assets/mockup-12-notifications.png)
