...
| VitalTrek-Project/vital-trek-platform | feature/engagement | - | feat(engagement): implement GET profile endpoint with base state handling | Se implementó el endpoint GET /api/v1/loyalty/profiles/{id} con manejo de perfil base para turistas sin historial de tours. | 16/06/2026 |
| VitalTrek-Project/vital-trek-platform | feature/engagement | - | feat(engagement): implement POST award endpoint with duplicate and validation checks | Se implementó el endpoint POST /api/v1/loyalty/profiles/{id}/award con validaciones de duplicado y datos incorrectos. | 16/06/2026 |
