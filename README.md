...
|---------|-------------|-------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 0.1     | 15/04/2026  | Rodriguez Rojas, Miler Alexander    | Se añadio la Carátula, el registro de versiones, la tabla con los Colaboration Insights, el Student Outcome, la descripción del startup, los perfiles de los integrantes y la sección de antecedentes y problematicas.                                                         |
...
| 0.5     | 19/04/2026  | Vilchez Vite, Gabriel Alejandro     | Se añadio el registro de la 4ta entrevista.                                                                                                                                                                                                                                    |
| 0.6     | 20/04/2026  | Rodriguez Rojas, Miler Alexander    | Se actualizó el registro de las primeras 4 entrevistas.                                                                                                                                                                                                                        |
| 0.7     | 21/04/2026  | Verastigue Martinez, Giancarlo Jose | Se añadieron los User Stories, Impact Mapping y el Product Backlog.                                                                                                                                                                                                            |
| 0.8     | 21/04/2026  | Quispe Perez, Eder Edu              | Se añadieron los User Persona.                                                                                                                                                                                                                                                 |
| 0.9     | 22/04/2026  | Quispe Perez, Eder Edu              | Se añadieron los Style Guidelines.                                                                                                                                                                                                                                             |
| 0.10    | 22/04/2026  | Vilchez Vite, Gabriel Alejandro     | Se añadieron los User Journey Mapping, los Empathy Mapping y el Big Picture Event Storming.                                                                                                                                                                                    |
| 0.11    | 22/04/2026  | Verastigue Martinez, Giancarlo Jose | Se actualizó los Lean UX Problem Statements, los Lean UX Assumptions, los Lean UX Hypothesis Statements y los segmentos objetivo.                                                                                                                                              |
| 0.12    | 22/04/2026  | Rodriguez Rojas, Miler Alexander    | Se añadio la sección de Landing Page Wireframe.                                                                                                                                                                                                                                |
| 0.13    | 23/04/2026  | Rodriguez Rojas, Miler Alexander    | Se añadio la sección de Landing Page Mock-up.                                                                                                                                                                                                                                  |
| 0.14    | 23/04/2026  | Quispe Perez, Eder Edu              | Se añadio el registro de la 5ta entrevista, el análisis de entrevistas y los User Task Matrix; aparte, se actualizó los General Style Guidelines.                                                                                                                              |
| 0.15    | 23/04/2026  | Vilchez Vite, Gabriel Alejandro     | Se añadio el Ubiquitous Language.                                                                                                                                                                                                                                              |
| 0.16    | 24/04/2026  | Quispe Perez, Eder Edu              | Se añadio el Labeling Systems, el SEO Tags and Meta Tags, los Searching Systems y los Navigation Systems.                                                                                                                                                                      |
| 0.17    | 25/04/2026  | Verastigue Martinez, Giancarlo Jose | Se añadio la sección de Software Configuration Management, la sección de Source Code Management, los Software Architecture Context Diagram, los Software Architecture Components Diagrams, los Class Diagrams y los Database Diagrams. Aparte, se actualizo el Lean Ux Canvas. |
| 0.18    | 26/04/2026  | Verastigue Martinez, Giancarlo Jose | Se actualizó los User Stories y el Product Backlog; además, se añadio el Source Code Managment.                                                                                                                                                                                |
| 0.19    | 26/04/2026  | Vilchez Vite, Gabriel Alejandro     | Se actualizó los User Journey Mapping y los Empathy Mapping; aparte, se añadio el Design Level EventStorming.                                                                                                                                                                  |
| 0.20    | 26/04/2026  | Quispe Perez, Eder Edu              | Se actualizó la introducción y se añadio las secciones de Source Code Style Guide & Coding Conventions, Software Deployment Configuration, Landing Page, Services & Applications Implementation; aparte, se añadio el Sprint 1.                                                |
| 0.21    | 26/04/2026  | Alfaro Mallma, Alberto Joaquin      | Se añadieron los Web Applications Wireframes, los Web Applications Mock-ups, los Web Applications User Flow Diagrams y los Web Applications Prototyping.                                                                                                                       |
| 0.22    | 09/05/2026  | Verastigue Martinez, Giancarlo Jose | Se corrigió el contenido del contenido del Cápitulo 1, el Lean UX Process, los User Journey Mapping y los Empathy Mapping                                                                                                                                                      |
| 0.23    | 09/05/2026  | Alfaro Mallma, Alberto Joaquin      | Se corrigió la sección de los Segmentos Objetivo, el Startup Profile, la sección de los Competidores, el Registro de Versiones del Informe, el Project Report Collaboration Insights y la sección de las entrevistas.                                                          |
| 0.24    | 09/05/2026  | Vilchez Vite, Gabriel Alejandro     | Se corrigió los Lean UX Problem Statements, los Lean UX Assumptions, el Big Picture Event Storming y el Ubiquitous Language.                                                                                                                                                   |
| 0.25    | 09/05/2026  | Rodriguez Rojas, Miler Alexander    | Se corrigió el Solution Profile, la sección de Antecedentes y problemática, los User Stories, los Impact Mapping y el Product Backlog.                                                                                                                                         |
| 0.26    | 10/05/2026  | Verastigue Martinez, Giancarlo Jose | Se corrigió los Empathy Maps.                                                                                                                                                                                                                                                  |
| 0.27    | 10/05/2026  | Rodriguez Rojas, Miler Alexander    | Se corrigió el Product Backlog.                                                                                                                                                                                                                                                |
| 0.28    | 11/05/2026  | Rodriguez Rojas, Miler Alexander    | Se añadio la tabla de Software Configuration Management, el Source Code Management y el Software Deployment Configuration; aparte, se actualizó los User Stories.                                                                                                              |
| 0.29    | 11/05/2026  | Vilchez Vite, Gabriel Alejandro     | Se añadio los Web Applications User Flow Diagrams.                                                                                                                                                                                                                             |
| 0.30    | 11/05/2026  | Alfaro Mallma, Alberto Joaquin      | Se actualizó los User Stories.                                                                                                                                                                                                                                                 |
...
- **Quispe Perez, Eder Edu - U202324623**
  - AV1: Lideró el análisis de requerimientos funcionales, definiendo los casos de uso principales y alineando la propuesta con los objetivos del proyecto.
- **Rodriguez Rojas, Miler Alexander - U20241A827**
  - AV1: Lideró la documentación técnica, estructurando los diagramas UML y asegurando la trazabilidad entre diseño y entregables.
- **Verastigue Martinez, Giancarlo Jose - U202419483**
  - AV1: Lideró la validación de la experiencia de usuario, proponiendo mejoras en la interfaz y asegurando la usabilidad del sistema.
- **Vilchez Vite, Gabriel Alejandro - U202416903**
  - AV1: Lideró el diseño visual y la integración de componentes de presentación, garantizando consistencia estética y funcional en la aplicación.
...
- **Quispe Perez, Eder Edu - U202324623**
  - AV1: Colaboró en la definición de objetivos del sistema y apoyó en la coherencia del enfoque funcional dentro del reporte.
- **Rodriguez Rojas, Miler Alexander - U20241A827**
  - AV1: Contribuyó en la construcción del reporte técnico y en la organización de entregables, asegurando consistencia documental.
- **Verastigue Martinez, Giancarlo Jose - U202419483**
  - AV1: Participó en la validación de requerimientos y pruebas de usabilidad, asegurando que el desarrollo esté centrado en el usuario.
- **Vilchez Vite, Gabriel Alejandro - U202416903**
  - AV1: Implementó el diseño visual del sistema y colaboró en la construcción del reporte, asegurando consistencia visual y funcional.
...
| Foto | Integrante |
|------|-----------|
| ![Joaquin_foto](assets/images/Joaquin_foto.png) | **Alfaro Mallma, Alberto Joaquin** — Código de Estudiante: U20241A267. Soy estudiante de Ingeniería de Software de quinto ciclo, enfocado en el desarrollo de soluciones web creativas y funcionales. Me considero una persona creativa, responsable y con capacidad para trabajar en equipo, aportando ideas innovadoras y adaptándome a las necesidades del proyecto. Cuento con conocimientos en HTML, CSS, JavaScript, Angular 7 y Node.js, que aplico en proyectos académicos y personales. |
| ![Edu_foto](assets/images/Edu_foto.png) | **Quispe Perez, Eder Edu** — Código de Estudiante: U202324623. Soy estudiante de Ingeniería de Software en la UPC, manejo Python y C++, y en mi tiempo libre me gusta ver películas y series. |
| ![Miler_foto](assets/images/Miler_foto.png) | **Rodriguez Rojas, Miler Alexander** — Código de Estudiante: U20241A827. Soy estudiante de Ingeniería de Software de quinto ciclo, enfocado en soluciones tecnológicas eficientes. Me considero una persona con liderazgo, capaz de trabajar en equipo y adaptarme rápidamente a distintos entornos. Tengo conocimientos en SQL Server, C++, HTML, CSS y Python. |
| ![Gabriel_foto](assets/images/Gabriel_foto.png) | **Vilchez Vite, Gabriel Alejandro** — Código de Estudiante: U202416903. Estudio Ingeniería de Software en mi 5to ciclo. Soy responsable, ordenado y tengo conocimientos en matemáticas, C++ y Matlab. |
| ![Giancarlo_foto](assets/images/Giancarlo_foto.png) | **Verastigue Martinez, Giancarlo Jose** — Código de Estudiante: U202419483. Soy estudiante de Ingeniería de Software con experiencia trabajando en equipo y bajo presión. Me considero organizado y detallista, con habilidades para afrontar problemas de manera exitosa. |
---
...
El siguiente glosario define los términos clave del dominio de turismo de aventura en zonas de baja conectividad. Su propósito es establecer un lenguaje común entre todos los stakeholders, evitando ambigüedades y facilitando la comunicación dentro del proyecto.

### Glosario

Adventure Tour (Tour de Aventura): Actividad organizada que involucra recorridos en entornos naturales, generalmente con cierto nivel de riesgo y condiciones variables.


Tour Operator (Operador de Turismo / Agencia): Entidad responsable de planificar, organizar y supervisar tours de aventura, asegurando la logística y seguridad del grupo.


Tour Guide (Guía de Turismo): Persona encargada de liderar al grupo durante el recorrido, brindando orientación, asistencia y apoyo en situaciones de riesgo.


Traveler (Turista / Viajero): Persona que participa en el tour de aventura y busca experiencias recreativas en entornos naturales.


Route (Ruta): Camino o trayecto definido que los participantes siguen durante el recorrido, el cual puede incluir distintos niveles de dificultad y riesgo.


Remote Area (Zona Remota): Entorno geográfico con acceso limitado a infraestructura, caracterizado por baja o nula conectividad y dificultad para recibir asistencia inmediata.


Low Connectivity (Baja Conectividad): Condición en la que la comunicación digital es limitada o inexistente, afectando la transmisión de información en tiempo real.


Checkpoint (Punto de Control): Ubicación dentro de la ruta donde se registra el paso de los participantes o se valida su progreso durante el recorrido.


Group Tracking (Seguimiento de Grupo): Proceso de supervisar la ubicación y el estado general de los participantes durante el desarrollo del tour.


Health Monitoring (Monitoreo de Salud): Seguimiento de las condiciones físicas del turista durante la actividad, especialmente en entornos exigentes como altura o esfuerzo físico prolongado.


Vital Signs (Signos Vitales): Indicadores básicos del estado de salud de una persona, como frecuencia cardíaca o nivel de oxígeno, relevantes en contextos de riesgo.


Incident (Incidente): Evento inesperado que afecta la seguridad o el bienestar de los participantes durante el recorrido.


Emergency Response (Respuesta a Emergencias): Acciones tomadas para atender un incidente, incluyendo comunicación, asistencia y evacuación si es necesario.


Situational Awareness (Conciencia Situacional): Capacidad de comprender lo que ocurre en el entorno del tour en un momento determinado, incluyendo ubicación, condiciones y riesgos.


Risk Level (Nivel de Riesgo): Grado de peligro asociado a una ruta o actividad, determinado por factores como terreno, clima y dificultad.


Safety Protocol (Protocolo de Seguridad): Conjunto de medidas y procedimientos establecidos para prevenir y responder a incidentes durante el recorrido.


Offline Navigation (Navegación sin Conexión): Capacidad de orientarse y seguir una ruta sin depender de conexión a internet.


Tour Completion (Finalización del Tour): Momento en el que el grupo completa la ruta y concluye la actividad planificada.
...
|---|---|---|---|---|
| **EP01** | **Identity & Access** | Agrupa las funcionalidades relacionadas con el registro, autenticación, verificación, recuperación de credenciales, gestión de sesiones y ciclo de vida de la cuenta de los usuarios de la plataforma. | — | — |
| US01 | Registro de turista | Como turista, quiero registrarme en la plataforma para acceder a los tours y funcionalidades disponibles del sistema. | **Escenario 1: Registro exitoso**; Given que el turista proporciona información válida y completa; When envía la solicitud de registro; Then el sistema crea la cuenta correctamente y retorna confirmación de registro; **Escenario 2: Registro mediante autenticación externa**; Given que el turista opta por registrarse mediante una cuenta de Google válida; When autoriza el acceso a sus datos; Then el sistema crea la cuenta automáticamente con la información obtenida del proveedor externo y autentica al turista; **Escenario 3: Correo ya registrado**; Given que el correo proporcionado ya existe en el sistema; When el turista envía la solicitud de registro; Then el sistema retorna un error indicando que el correo ya se encuentra registrado | EP01 |
| US02 | Registro de administrador de agencia | Como administrador de agencia, quiero registrar mi agencia en la plataforma para gestionar tours y monitorear a los turistas asignados. | **Escenario 1: Registro exitoso**; Given que el administrador de agencia proporciona información válida de la empresa; When envía la solicitud de registro; Then el sistema crea la cuenta con el rol correspondiente y retorna confirmación; **Escenario 2: Correo duplicado**; Given que el correo proporcionado ya está asociado a una cuenta existente; When el administrador de agencia envía la solicitud de registro; Then el sistema retorna un error indicando que el correo ya está registrado; **Escenario 3: Datos inválidos**; Given que el administrador de agencia ingresa datos con formato incorrecto; When envía la solicitud de registro; Then el sistema retorna un error indicando los campos con formato inválido | EP01 |
| US03 | Inicio de sesión | Como usuario registrado, quiero iniciar sesión de forma segura para acceder a las funcionalidades de la plataforma según mi rol. | **Escenario 1: Credenciales válidas**; Given que el usuario registrado proporciona credenciales correctas; When envía la solicitud de autenticación; Then el sistema valida las credenciales y retorna un token de acceso con el rol asociado; **Escenario 2: Credenciales inválidas**; Given que el usuario registrado proporciona credenciales incorrectas; When envía la solicitud de autenticación; Then el sistema retorna un error sin revelar cuál de los campos es incorrecto; **Escenario 3: Cuenta inactiva**; Given que la cuenta del usuario se encuentra deshabilitada; When el usuario envía la solicitud de autenticación; Then el sistema retorna un error indicando que la cuenta no está activa | EP01 |
| US04 | Recuperación de contraseña | Como usuario registrado, quiero recuperar mi contraseña para no perder el acceso a mi cuenta en la plataforma. | **Escenario 1: Solicitud exitosa**; Given que el usuario registrado proporciona un correo válido y registrado; When envía la solicitud de recuperación; Then el sistema genera un enlace de recuperación con vigencia limitada y lo envía al correo indicado; **Escenario 2: Enlace expirado**; Given que el enlace de recuperación ha superado su tiempo de validez; When el usuario intenta utilizarlo; Then el sistema retorna un error indicando que el enlace ya no es válido; **Escenario 3: Correo no registrado**; Given que el correo proporcionado no existe en el sistema; When el usuario envía la solicitud de recuperación; Then el sistema retorna un error indicando que el correo no está registrado | EP01 |
| US05 | Verificación de correo electrónico | Como turista, quiero verificar mi correo electrónico tras el registro para confirmar la validez de mi cuenta. | **Escenario 1: Verificación exitosa**; Given que el turista recibe el enlace de verificación tras el registro; When confirma la verificación mediante el enlace; Then el sistema activa la cuenta del turista y retorna confirmación; **Escenario 2: Enlace expirado**; Given que el enlace de verificación ha superado su tiempo de validez; When el turista intenta utilizarlo; Then el sistema retorna un error e indica al turista que puede solicitar un nuevo enlace de verificación; **Escenario 3: Reenvío de correo de verificación**; Given que el turista solicita el reenvío del correo de verificación; When el sistema procesa la solicitud; Then el sistema genera un nuevo enlace de verificación y lo envía al correo registrado | EP01 |
| US06 | Cambio de contraseña | Como usuario registrado, quiero cambiar mi contraseña para mantener la seguridad de mi cuenta. | **Escenario 1: Cambio exitoso**; Given que el usuario registrado proporciona la contraseña actual correcta y una nueva contraseña válida; When envía la solicitud de cambio; Then el sistema actualiza la contraseña correctamente e invalida las sesiones activas distintas a la actual; **Escenario 2: Contraseña actual incorrecta**; Given que el usuario registrado proporciona una contraseña actual incorrecta; When envía la solicitud de cambio; Then el sistema retorna un error indicando que la contraseña actual es incorrecta; **Escenario 3: Nueva contraseña no cumple requisitos**; Given que la nueva contraseña no cumple los requisitos de seguridad definidos; When el usuario envía la solicitud de cambio; Then el sistema retorna un error indicando los requisitos no cumplidos | EP01 |
| US07 | Cierre de sesiones activas | Como usuario registrado, quiero cerrar todas mis sesiones activas en otros dispositivos para proteger mi cuenta. | **Escenario 1: Cierre exitoso**; Given que el usuario registrado tiene sesiones activas en otros dispositivos; When solicita el cierre de sesiones; Then el sistema invalida todos los tokens de sesión activos distintos al actual; **Escenario 2: Sin sesiones adicionales**; Given que el usuario registrado no tiene otras sesiones activas; When solicita el cierre de sesiones; Then el sistema retorna una respuesta indicando que no existen sesiones adicionales que cerrar; **Escenario 3: Desactivación de cuenta**; Given que el usuario registrado confirma la desactivación de su cuenta; When envía la solicitud de desactivación; Then el sistema marca la cuenta como inactiva, invalida todas las sesiones activas y retorna confirmación | EP01 |
| US08 | Vincular dispositivo wearable | Como turista, quiero vincular un dispositivo wearable a mi cuenta para que el sistema capture mis signos vitales durante la expedición. | **Escenario 1: Vinculación exitosa**; Given que el turista dispone de un wearable compatible y proporciona el identificador del dispositivo; When envía la solicitud de vinculación; Then el sistema asocia el dispositivo a la cuenta del turista y retorna confirmación; **Escenario 2: Dispositivo ya vinculado**; Given que el identificador del dispositivo ya está asociado a otra cuenta; When el turista envía la solicitud de vinculación; Then el sistema retorna un error indicando que el dispositivo ya está vinculado; **Escenario 3: Desvinculación durante expedición activa**; Given que el dispositivo está transmitiendo datos durante una expedición activa; When el turista envía la solicitud de desvinculación; Then el sistema retorna un error indicando que no es posible desvincular un dispositivo activo durante una expedición | EP01 |
| **EP02** | **Tour Management** | Agrupa las funcionalidades de creación, edición, eliminación, duplicación, asignación y consulta de tours por parte del administrador de agencia, así como la búsqueda, filtrado y confirmación de asistencia por parte del turista. | — | — |
| US09 | Crear tour | Como administrador de agencia, quiero crear un tour para organizar rutas y ponerlas a disposición de los turistas. | **Escenario 1: Creación exitosa**; Given que el administrador de agencia proporciona información válida y completa del tour; When envía la solicitud de creación; Then el sistema registra el tour correctamente y retorna confirmación; **Escenario 2: Campos obligatorios incompletos**; Given que el administrador de agencia omite campos obligatorios; When envía la solicitud de creación; Then el sistema retorna un error indicando los campos requeridos faltantes; **Escenario 3: Datos con formato inválido**; Given que el administrador de agencia ingresa datos con formato incorrecto; When envía la solicitud de creación; Then el sistema retorna un error indicando los campos con formato inválido | EP02 |
| US10 | Editar tour | Como administrador de agencia, quiero editar la información de un tour para mantener actualizados los datos del recorrido. | **Escenario 1: Edición exitosa**; Given que el administrador de agencia modifica información válida de un tour existente; When envía la solicitud de actualización; Then el sistema aplica los cambios correctamente y retorna confirmación; **Escenario 2: Datos inválidos**; Given que el administrador de agencia ingresa datos con formato incorrecto; When envía la solicitud de actualización; Then el sistema retorna un error indicando los campos con formato inválido; **Escenario 3: Tour no encontrado**; Given que el administrador de agencia intenta modificar un tour inexistente; When envía la solicitud de actualización; Then el sistema retorna un error indicando que el recurso no existe | EP02 |
| US11 | Eliminar tour | Como administrador de agencia, quiero eliminar un tour para mantener actualizado el catálogo de la agencia. | **Escenario 1: Eliminación exitosa**; Given que el administrador de agencia confirma la eliminación de un tour existente; When envía la solicitud de eliminación; Then el sistema elimina el tour de forma permanente y retorna confirmación; **Escenario 2: Tour con expedición en curso**; Given que el administrador de agencia intenta eliminar un tour cuya expedición se encuentra activa; When envía la solicitud de eliminación; Then el sistema retorna un error indicando que no es posible eliminar un tour con expedición activa; **Escenario 3: Tour no encontrado**; Given que el administrador de agencia intenta eliminar un tour inexistente; When envía la solicitud de eliminación; Then el sistema retorna un error indicando que el recurso no existe | EP02 |
| US12 | Duplicar tour | Como administrador de agencia, quiero duplicar un tour existente para crear uno nuevo basado en una configuración previamente validada. | **Escenario 1: Duplicación exitosa**; Given que el administrador de agencia selecciona un tour existente; When envía la solicitud de duplicación; Then el sistema crea una copia del tour con estado borrador y retorna confirmación; **Escenario 2: Tour origen no disponible**; Given que el administrador de agencia intenta duplicar un tour eliminado o inaccesible; When envía la solicitud de duplicación; Then el sistema retorna un error indicando que el tour origen no existe; **Escenario 3: Error durante la duplicación**; Given que ocurre un fallo interno al procesar la duplicación; When el administrador de agencia envía la solicitud; Then el sistema retorna un error indicando que la operación no pudo completarse | EP02 |
| US13 | Asignar turistas a un tour | Como administrador de agencia, quiero asignar turistas a un tour para conformar el grupo de participantes del recorrido. | **Escenario 1: Asignación exitosa**; Given que el administrador de agencia selecciona turistas registrados para un tour disponible; When envía la solicitud de asignación; Then el sistema registra la asignación correctamente y retorna confirmación; **Escenario 2: Turista ya asignado**; Given que el turista seleccionado ya pertenece al tour; When el administrador de agencia envía la solicitud de asignación; Then el sistema retorna un error indicando que el turista ya está asignado; **Escenario 3: Tour cerrado o cancelado**; Given que el tour se encuentra cerrado o cancelado; When el administrador de agencia intenta asignar turistas; Then el sistema retorna un error indicando que el tour no acepta nuevas asignaciones | EP02 |
| US14 | Desasignar turista de un tour | Como administrador de agencia, quiero desasignar a un turista de un tour para actualizar la composición del grupo. | **Escenario 1: Desasignación exitosa**; Given que el administrador de agencia selecciona un turista asignado a un tour; When envía la solicitud de desasignación; Then el sistema retira al turista del tour y retorna confirmación; **Escenario 2: Expedición ya iniciada**; Given que el administrador de agencia intenta desasignar a un turista de un tour cuya expedición se encuentra en curso; When envía la solicitud de desasignación; Then el sistema requiere confirmación adicional antes de procesar la solicitud; **Escenario 3: Turista no asignado al tour**; Given que el turista seleccionado no pertenece al tour indicado; When el administrador de agencia envía la solicitud de desasignación; Then el sistema retorna un error indicando que el turista no está asignado a ese tour | EP02 |
| US15 | Confirmar asistencia | Como turista, quiero confirmar mi asistencia a un tour para asegurar mi participación en el recorrido. | **Escenario 1: Confirmación exitosa**; Given que el turista está asignado a un tour disponible; When envía la solicitud de confirmación de asistencia; Then el sistema actualiza el estado de participación correctamente; **Escenario 2: Cancelación de participación**; Given que el turista ha confirmado previamente su asistencia; When envía la solicitud de cancelación; Then el sistema actualiza el estado de participación y notifica al administrador de agencia; **Escenario 3: Expedición ya iniciada**; Given que la expedición del tour al que pertenece el turista ya ha comenzado; When el turista envía la solicitud de cancelación; Then el sistema retorna un error indicando que no es posible modificar la participación | EP02 |
| US16 | Buscar y filtrar tours | Como turista, quiero buscar y filtrar los tours disponibles para encontrar opciones acordes a mis intereses y preferencias. | **Escenario 1: Búsqueda con resultados**; Given que el turista proporciona un término de búsqueda válido; When el sistema procesa la consulta; Then el sistema retorna los tours cuya información coincide con el término ingresado; **Escenario 2: Filtro con resultados**; Given que el turista aplica criterios de filtrado válidos; When el sistema procesa la consulta; Then el sistema retorna los tours que cumplen los criterios indicados; **Escenario 3: Búsqueda sin coincidencias**; Given que el término o criterios proporcionados no coinciden con ningún tour disponible; When el sistema procesa la consulta; Then el sistema retorna una respuesta vacía indicando que no hay coincidencias | EP02 |
| US17 | Consultar detalle del tour | Como turista, quiero acceder a la información completa de un tour para tomar una decisión informada antes de participar. | **Escenario 1: Consulta exitosa**; Given que el tour solicitado existe en el sistema; When el turista solicita el detalle; Then el sistema retorna la información completa del recorrido incluyendo ruta, checkpoints y dificultad; **Escenario 2: Tour no encontrado**; Given que el tour solicitado no existe en el sistema; When el turista solicita el detalle; Then el sistema retorna un error indicando que el recurso no existe; **Escenario 3: Consulta de turistas asignados**; Given que el administrador de agencia solicita la lista de turistas de un tour existente; When el sistema procesa la solicitud; Then el sistema retorna los datos relevantes de cada turista asignado junto con su estado de confirmación | EP02 |
| US18 | Consultar tours de la agencia | Como administrador de agencia, quiero consultar todos los tours registrados por mi agencia para gestionarlos de forma centralizada. | **Escenario 1: Consulta con resultados**; Given que la agencia tiene tours registrados en el sistema; When el administrador de agencia solicita la consulta; Then el sistema retorna el listado completo de tours con su estado actual; **Escenario 2: Filtro por estado**; Given que el administrador de agencia aplica un filtro por estado del tour; When el sistema procesa la consulta; Then el sistema retorna únicamente los tours que coinciden con el estado indicado; **Escenario 3: Sin tours registrados**; Given que la agencia no tiene tours registrados; When el administrador de agencia solicita la consulta; Then el sistema retorna una respuesta vacía indicando la ausencia de tours | EP02 |
| **EP03** | **Navigation & Exploration** | Agrupa las funcionalidades relacionadas con la ejecución de expediciones, navegación de ruta, visualización de checkpoints, progreso del recorrido, registro de experiencias, consulta de clima y operación en campo por parte del guía de tour. | — | — |
| US19 | Iniciar expedición | Como guía de tour, quiero marcar el inicio de la expedición para activar el monitoreo y registro del recorrido. | **Escenario 1: Inicio exitoso**; Given que el guía de tour está asignado a un tour pendiente de iniciar; When envía la solicitud de inicio; Then el sistema activa la expedición y retorna confirmación; **Escenario 2: Expedición ya iniciada**; Given que la expedición del tour seleccionado ya se encuentra activa; When el guía de tour envía la solicitud de inicio; Then el sistema retorna un error indicando que la expedición ya se encuentra en curso; **Escenario 3: Guía no asignado al tour**; Given que el guía de tour no está asignado al tour que intenta iniciar; When envía la solicitud de inicio; Then el sistema retorna un error indicando que no tiene permisos para iniciar esa expedición | EP03 |
| US20 | Visualizar ruta del tour | Como turista, quiero acceder a la ruta del tour para orientarme durante el recorrido. | **Escenario 1: Acceso con conexión**; Given que el turista tiene una expedición activa asignada y conexión disponible; When solicita la información de la ruta; Then el sistema retorna los datos completos del recorrido; **Escenario 2: Acceso sin conexión**; Given que el turista descargó previamente la ruta y no tiene conexión; When solicita la información de la ruta; Then el sistema retorna los datos desde el almacenamiento local; **Escenario 3: Ruta no disponible**; Given que el turista no tiene una expedición activa y no ha descargado ninguna ruta; When solicita la información; Then el sistema retorna un error indicando que no hay rutas disponibles | EP03 |
| US21 | Descargar ruta offline | Como turista, quiero descargar la información de la ruta de un tour para utilizarla sin conexión durante el recorrido. | **Escenario 1: Descarga exitosa**; Given que el turista solicita la descarga de una ruta disponible; When el sistema procesa la solicitud; Then el sistema almacena la información localmente y retorna confirmación; **Escenario 2: Acceso posterior sin conexión**; Given que el turista descargó previamente la información y no tiene conexión; When solicita acceso a la ruta; Then el sistema retorna la información desde el almacenamiento local sin requerir conexión; **Escenario 3: Ruta no disponible para descarga**; Given que el turista intenta descargar una ruta que no existe en el sistema; When el sistema procesa la solicitud; Then el sistema retorna un error indicando que la ruta no está disponible | EP03 |
| US22 | Visualizar checkpoints del recorrido | Como turista, quiero conocer los checkpoints del tour para identificar mi progreso durante el recorrido. | **Escenario 1: Consulta de checkpoints**; Given que el turista tiene una expedición activa; When solicita la información de checkpoints; Then el sistema retorna los checkpoints diferenciando los completados de los pendientes; **Escenario 2: Checkpoint detectado automáticamente**; Given que el turista se aproxima a un checkpoint registrado; When el sistema procesa la proximidad; Then el sistema marca el checkpoint como completado y actualiza el progreso del turista; **Escenario 3: Sin expedición activa**; Given que el turista no tiene una expedición activa; When solicita la información de checkpoints; Then el sistema retorna un error indicando que no existe una expedición activa asociada | EP03 |
| US23 | Visualizar progreso del recorrido | Como turista, quiero consultar mi avance en el tour para conocer cuánto resta por completar. | **Escenario 1: Consulta de progreso**; Given que el turista tiene una expedición activa; When solicita la información de progreso; Then el sistema retorna el porcentaje completado y los checkpoints restantes; **Escenario 2: Actualización automática**; Given que el turista completa un tramo o checkpoint del recorrido; When el sistema procesa el evento; Then el sistema actualiza el porcentaje de avance del turista; **Escenario 3: Recorrido completado**; Given que el turista ha completado todos los checkpoints de la expedición; When el sistema procesa el último evento de progreso; Then el sistema retorna un porcentaje de avance del cien por ciento y notifica la finalización del recorrido | EP03 |
| US24 | Registrar checkpoint manual | Como guía de tour, quiero registrar manualmente el paso del grupo por un checkpoint para garantizar la trazabilidad cuando la detección automática no es posible. | **Escenario 1: Registro exitoso**; Given que el guía de tour confirma el paso del grupo por un checkpoint válido; When envía la solicitud de registro; Then el sistema marca el checkpoint como completado para el grupo y retorna confirmación; **Escenario 2: Checkpoint ya registrado**; Given que el checkpoint seleccionado ya está marcado como completado; When el guía de tour envía la solicitud de registro; Then el sistema retorna un error indicando que el checkpoint ya fue registrado; **Escenario 3: Checkpoint no pertenece a la expedición activa**; Given que el checkpoint seleccionado no pertenece a la expedición que el guía tiene activa; When envía la solicitud de registro; Then el sistema retorna un error indicando que el checkpoint no corresponde a la expedición en curso | EP03 |
| US25 | Registrar experiencia del recorrido | Como turista, quiero registrar notas durante el tour para documentar mi experiencia. | **Escenario 1: Registro exitoso**; Given que el turista proporciona contenido válido durante una expedición activa; When envía la solicitud de registro; Then el sistema almacena la información asociada al tour y al punto del recorrido; **Escenario 2: Consulta del historial**; Given que el turista solicita el historial de experiencias registradas; When el sistema procesa la solicitud; Then el sistema retorna las experiencias asociadas a los tours del turista; **Escenario 3: Sin expedición activa**; Given que el turista intenta registrar una experiencia sin tener una expedición activa; When envía la solicitud de registro; Then el sistema retorna un error indicando que no es posible registrar experiencias fuera de una expedición activa | EP03 |
| US26 | Consultar clima del recorrido | Como turista, quiero consultar la información climática del recorrido para prepararme con el equipamiento adecuado. | **Escenario 1: Consulta con conexión**; Given que el turista solicita información climática con conexión activa; When el sistema consulta el servicio externo de clima; Then el sistema retorna información actualizada para la zona del recorrido; **Escenario 2: Consulta sin conexión**; Given que el turista solicita información climática sin conexión; When el sistema procesa la solicitud; Then el sistema retorna la última información climática almacenada localmente; **Escenario 3: Servicio externo no disponible**; Given que el servicio externo de clima no responde; When el sistema intenta obtener la información; Then el sistema retorna un error indicando que el servicio no está disponible temporalmente | EP03 |
| US27 | Sincronización asincrónica de datos offline | Como turista, quiero que los datos capturados durante la expedición se sincronicen automáticamente al recuperar la conexión para no perder ningún registro generado. | **Escenario 1: Sincronización exitosa**; Given que el dispositivo del turista tiene datos almacenados localmente y recupera la conexión; When el sistema procesa la sincronización; Then el sistema transmite los datos al servidor y retorna confirmación; **Escenario 2: Datos duplicados**; Given que algunos registros ya fueron sincronizados previamente; When el sistema procesa la sincronización; Then el sistema descarta los duplicados y procesa únicamente los registros nuevos; **Escenario 3: Error durante la sincronización**; Given que ocurre un fallo durante la transmisión de datos; When el sistema procesa la sincronización; Then el sistema conserva los datos localmente y agenda un nuevo intento de transmisión | EP03 |
| US28 | Finalizar expedición | Como guía de tour, quiero marcar la finalización de la expedición para cerrar formalmente el monitoreo del recorrido. | **Escenario 1: Finalización exitosa**; Given que el guía de tour está asignado a una expedición activa; When envía la solicitud de finalización; Then el sistema cierra la expedición y retorna confirmación; **Escenario 2: Expedición ya finalizada**; Given que la expedición seleccionada ya se encuentra cerrada; When el guía de tour envía la solicitud de finalización; Then el sistema retorna un error indicando que la expedición ya fue finalizada; **Escenario 3: Finalización con progreso parcial**; Given que el turista no completó todos los checkpoints de la expedición; When el guía envía la solicitud de finalización; Then el sistema registra la expedición con el progreso alcanzado y la agrega al historial como completada parcialmente | EP03 |
| **EP04** | **Safety & Monitoring** | Agrupa las funcionalidades de monitoreo de ubicación, estado de salud, telemetría IoT, detección de anomalías, gestión de alertas y reporte de incidentes durante las expediciones. | — | — |
| US29 | Monitorear ubicación de turistas | Como administrador de agencia, quiero consultar la ubicación de los turistas para supervisar su seguridad durante la expedición. | **Escenario 1: Ubicaciones disponibles**; Given que existen registros de ubicación activos para los turistas de una expedición; When el administrador de agencia solicita el estado de ubicación; Then el sistema retorna las coordenadas actuales de cada turista; **Escenario 2: Turista sin señal**; Given que un turista ha dejado de transmitir datos de ubicación; When el administrador de agencia solicita el estado; Then el sistema retorna la última ubicación registrada junto con la marca de tiempo; **Escenario 3: Expedición sin datos activos**; Given que no existen registros de ubicación para la expedición consultada; When el administrador de agencia solicita el estado; Then el sistema retorna una respuesta vacía indicando que no hay datos disponibles | EP04 |
| US30 | Consultar estado general del grupo | Como administrador de agencia, quiero consultar el estado general de los turistas para detectar situaciones de riesgo durante la expedición. | **Escenario 1: Estado consolidado disponible**; Given que existen datos activos de los participantes de una expedición; When el administrador de agencia solicita el estado general; Then el sistema retorna información consolidada del estado de cada participante; **Escenario 2: Anomalía detectada**; Given que el sistema identifica una condición fuera del rango establecido; When procesa los datos del grupo; Then el sistema genera una notificación de alerta al administrador de agencia responsable; **Escenario 3: Sin datos activos**; Given que la expedición no tiene participantes con datos activos; When el administrador de agencia solicita el estado general; Then el sistema retorna una respuesta indicando que no existen datos disponibles | EP04 |
| US31 | Recibir alertas por anomalías | Como administrador de agencia, quiero recibir alertas ante situaciones de riesgo para responder oportunamente durante las expediciones. | **Escenario 1: Desvío de ruta detectado**; Given que un turista se encuentra fuera del área definida para el recorrido; When el sistema procesa los datos de ubicación; Then el sistema genera una alerta y la notifica al administrador de agencia responsable; **Escenario 2: Pérdida de comunicación**; Given que un turista deja de transmitir datos durante un periodo superior al umbral configurado; When el sistema detecta la interrupción; Then el sistema genera una alerta de pérdida de conexión y la notifica al administrador de agencia; **Escenario 3: Signos vitales fuera de rango**; Given que los datos biométricos de un turista superan los umbrales críticos configurados; When el sistema procesa los datos; Then el sistema genera una alerta preventiva de salud y la notifica al administrador de agencia | EP04 |
| US32 | Consultar estado de salud básico | Como guía de tour, quiero consultar alertas básicas del estado de salud de los turistas para actuar oportunamente ante posibles emergencias. | **Escenario 1: Datos biométricos disponibles**; Given que existen datos biométricos activos para los turistas de una expedición; When el guía de tour solicita el estado de salud; Then el sistema retorna el estado de salud básico de cada turista; **Escenario 2: Valores críticos detectados**; Given que el sistema identifica valores biométricos fuera del rango normal; When procesa los datos del turista; Then el sistema genera una alerta preventiva y la notifica al guía de tour responsable; **Escenario 3: Sin datos biométricos disponibles**; Given que el dispositivo del turista no transmite datos biométricos; When el guía de tour solicita el estado de salud; Then el sistema retorna el último estado registrado junto con la marca de tiempo | EP04 |
| US33 | Reportar incidente | Como turista, quiero reportar incidentes para alertar oportunamente al personal responsable durante la expedición. | **Escenario 1: Reporte con conexión**; Given que el turista genera un reporte con información válida y tiene conexión activa; When envía el reporte; Then el sistema registra el incidente y notifica al administrador de agencia responsable; **Escenario 2: Reporte sin conexión**; Given que el dispositivo del turista no tiene conexión a internet; When el turista envía el reporte; Then el sistema almacena el incidente localmente y lo sincroniza cuando se recupera la conexión; **Escenario 3: Información incompleta**; Given que el turista envía un reporte con campos obligatorios faltantes; When el sistema procesa la solicitud; Then el sistema retorna un error indicando los campos requeridos | EP04 |
| US34 | Reportar incidente desde el rol guía | Como guía de tour, quiero reportar incidentes detectados en campo para informar oportunamente al administrador de agencia. | **Escenario 1: Reporte exitoso con conexión**; Given que el guía de tour proporciona información válida del incidente y tiene conexión; When envía el reporte; Then el sistema registra el incidente y notifica al administrador de agencia responsable; **Escenario 2: Reporte sin conexión**; Given que el dispositivo del guía de tour no tiene conexión; When envía el reporte; Then el sistema almacena el incidente localmente y lo sincroniza al recuperar la conexión; **Escenario 3: Resolución de incidente**; Given que el administrador de agencia recibe un incidente reportado; When registra la resolución con una nota válida; Then el sistema actualiza el estado del incidente a resuelto y retorna confirmación | EP04 |
| US35 | Recibir datos biométricos del wearable | Como turista, quiero que el sistema reciba los datos biométricos capturados por mi wearable para que sean utilizados en el monitoreo de mi salud durante la expedición. | **Escenario 1: Recepción exitosa**; Given que el wearable transmite datos biométricos válidos durante una expedición activa; When el sistema procesa la transmisión; Then el sistema registra los datos asociados al turista y a la expedición correspondiente; **Escenario 2: Datos con formato inválido**; Given que el wearable transmite datos con formato incorrecto; When el sistema procesa la transmisión; Then el sistema descarta los datos y registra un evento de error; **Escenario 3: Sin expedición activa**; Given que el turista no tiene una expedición activa en el momento de la transmisión; When el sistema recibe los datos; Then el sistema descarta los datos y registra un evento informativo indicando que no había una expedición activa | EP04 |
| US36 | Consultar estado del wearable | Como turista, quiero consultar el estado de mi wearable para verificar su nivel de batería y conectividad antes de iniciar el recorrido. | **Escenario 1: Estado disponible**; Given que el wearable está vinculado y activo; When el turista solicita el estado del dispositivo; Then el sistema retorna información sobre nivel de batería, conectividad y última sincronización; **Escenario 2: Dispositivo desconectado**; Given que el wearable no está transmitiendo datos; When el turista solicita el estado del dispositivo; Then el sistema retorna el último estado registrado junto con la marca de tiempo; **Escenario 3: Dispositivo no vinculado**; Given que el turista no tiene ningún wearable vinculado a su cuenta; When solicita el estado del dispositivo; Then el sistema retorna un error indicando que no existe un dispositivo asociado a la cuenta | EP04 |
| US37 | Exportar reportes de expedición | Como administrador de agencia, quiero exportar reportes de las expediciones para analizar la información operativa. | **Escenario 1: Exportación exitosa**; Given que existen datos disponibles para la expedición solicitada; When el administrador de agencia solicita la exportación; Then el sistema genera correctamente el archivo con la información de la expedición; **Escenario 2: Sin datos disponibles**; Given que no existen datos registrados para la expedición solicitada; When el administrador de agencia solicita la exportación; Then el sistema retorna un error indicando que no hay información disponible para exportar; **Escenario 3: Formato de exportación inválido**; Given que el administrador de agencia solicita un formato de exportación no soportado; When el sistema procesa la solicitud; Then el sistema retorna un error indicando los formatos disponibles | EP04 |
| **EP05** | **Notification & Profile** | Agrupa las funcionalidades relacionadas con la administración del perfil personal del usuario, la configuración de preferencias de notificaciones y la recepción de notificaciones relevantes sobre eventos del sistema. | — | — |
| US38 | Gestionar perfil personal | Como usuario registrado, quiero gestionar mi información personal para mantener actualizados los datos asociados a mi cuenta. | **Escenario 1: Actualización exitosa**; Given que el usuario proporciona información válida; When envía la solicitud de actualización; Then el sistema aplica los cambios correctamente y retorna confirmación; **Escenario 2: Datos inválidos**; Given que el usuario ingresa información con formato incorrecto; When envía la solicitud de actualización; Then el sistema retorna un error indicando los campos con formato inválido; **Escenario 3: Campos obligatorios vacíos**; Given que el usuario omite campos obligatorios; When envía la solicitud de actualización; Then el sistema retorna un error indicando los campos requeridos faltantes | EP05 |
| US39 | Actualizar foto de perfil | Como usuario registrado, quiero actualizar mi foto de perfil para personalizar mi cuenta en la plataforma. | **Escenario 1: Actualización exitosa**; Given que el usuario proporciona un archivo de imagen con formato y tamaño válidos; When envía la solicitud de actualización; Then el sistema almacena la imagen y la asocia al perfil del usuario; **Escenario 2: Formato de archivo inválido**; Given que el usuario proporciona un archivo con extensión no soportada; When envía la solicitud de actualización; Then el sistema retorna un error indicando los formatos de imagen aceptados; **Escenario 3: Tamaño de archivo excedido**; Given que el archivo proporcionado supera el tamaño máximo permitido; When el sistema procesa la solicitud; Then el sistema retorna un error indicando el límite de tamaño permitido | EP05 |
| US40 | Configurar preferencias de notificaciones | Como usuario registrado, quiero configurar las preferencias de notificaciones para recibir únicamente las que considero relevantes. | **Escenario 1: Configuración exitosa**; Given que el usuario proporciona preferencias válidas; When envía la solicitud de configuración; Then el sistema aplica las preferencias y retorna confirmación; **Escenario 2: Restaurar preferencias por defecto**; Given que el usuario solicita restablecer las preferencias a los valores predeterminados; When el sistema procesa la solicitud; Then el sistema aplica la configuración por defecto y retorna confirmación; **Escenario 3: Configuración inválida**; Given que el usuario proporciona preferencias con formato incorrecto; When envía la solicitud de configuración; Then el sistema retorna un error indicando los parámetros inválidos | EP05 |
| US41 | Recibir notificaciones de seguridad | Como usuario registrado, quiero recibir notificaciones de alerta de seguridad para mantenerme informado sobre eventos críticos relacionados con mi expedición. | **Escenario 1: Notificación generada por alerta**; Given que el sistema detecta una condición crítica asociada a la expedición del usuario; When procesa el evento de seguridad; Then el sistema genera y envía la notificación al usuario correspondiente a través del canal configurado; **Escenario 2: Notificaciones de seguridad deshabilitadas**; Given que el usuario tiene deshabilitadas las notificaciones de alerta en su configuración; When ocurre un evento de seguridad que generaría una notificación; Then el sistema no envía la notificación y registra el evento internamente; **Escenario 3: Canal de notificación no disponible**; Given que el canal de notificación configurado no está disponible en el momento del evento; When el sistema intenta enviar la notificación; Then el sistema reintenta el envío por un canal alternativo y registra el intento fallido | EP05 |
| US42 | Recibir notificaciones de tour | Como turista, quiero recibir notificaciones sobre actualizaciones de mi tour para mantenerme informado sobre cambios en mi participación. | **Escenario 1: Notificación de asignación**; Given que el turista es asignado a un tour por el administrador de agencia; When el sistema procesa la asignación; Then el sistema envía una notificación al turista informando sobre su nueva asignación; **Escenario 2: Notificación de inicio de expedición**; Given que la expedición a la que pertenece el turista es iniciada por el guía; When el sistema registra el inicio; Then el sistema envía una notificación al turista indicando que la expedición ha comenzado; **Escenario 3: Notificación de cancelación**; Given que el tour al que pertenece el turista es cancelado por el administrador de agencia; When el sistema registra la cancelación; Then el sistema envía una notificación al turista informando sobre la cancelación del tour | EP05 |
| US43 | Consultar historial de notificaciones | Como usuario registrado, quiero consultar el historial de notificaciones recibidas para revisar eventos pasados relacionados con mi cuenta. | **Escenario 1: Consulta con resultados**; Given que el usuario tiene notificaciones registradas en el sistema; When solicita el historial de notificaciones; Then el sistema retorna el listado de notificaciones ordenadas cronológicamente; **Escenario 2: Marcar notificación como leída**; Given que el usuario selecciona una notificación no leída; When envía la solicitud de marcado; Then el sistema actualiza el estado de la notificación a leída y retorna confirmación; **Escenario 3: Sin notificaciones registradas**; Given que el usuario no tiene notificaciones en el sistema; When solicita el historial; Then el sistema retorna una respuesta vacía indicando la ausencia de notificaciones | EP05 |
| **EP06** | **Landing Page** | Agrupa las funcionalidades del sitio web estático que comunica la propuesta de valor de VitalTrek a los visitantes de cada segmento objetivo, permitiendo conocer las funcionalidades, beneficios y acceder al registro de la plataforma. | — | — |
| US-LP01 | Conocer la propuesta de valor | Como visitante, quiero conocer la propuesta de valor de VitalTrek para evaluar si la plataforma se ajusta a mis necesidades. | **Escenario 1: Contenido principal disponible**; Given que el visitante accede a la landing page; When el sistema entrega el contenido principal; Then el sistema retorna la información que comunica el propósito y el beneficio central de la plataforma; **Escenario 2: Acceso desde dispositivo móvil**; Given que el visitante accede a la landing page desde un dispositivo móvil; When el sistema procesa la solicitud; Then el sistema entrega el contenido adaptado al tamaño del dispositivo; **Escenario 3: Contenido no disponible**; Given que ocurre un fallo al entregar el contenido principal; When el visitante accede a la landing page; Then el sistema retorna un mensaje indicando que el contenido no está disponible temporalmente | EP06 |
| US-LP02 | Navegar entre secciones | Como visitante, quiero acceder a las distintas secciones de la landing page para conocer las funcionalidades del sistema. | **Escenario 1: Navegación exitosa**; Given que el visitante accede a la landing page; When solicita acceder a una sección específica; Then el sistema redirige al contenido correspondiente a la sección seleccionada; **Escenario 2: Acceso desde dispositivo móvil**; Given que el visitante accede desde un dispositivo móvil; When solicita acceder a una sección; Then el sistema entrega el contenido adaptado al tamaño del dispositivo; **Escenario 3: Sección no disponible**; Given que el visitante solicita una sección que no se encuentra disponible; When el sistema procesa la solicitud; Then el sistema retorna un mensaje indicando que la sección no está disponible temporalmente | EP06 |
| US-LP03 | Conocer beneficios para turistas | Como visitante del segmento turista, quiero conocer los beneficios específicos de la plataforma para comprender cómo mejora mi experiencia durante las expediciones. | **Escenario 1: Acceso al contenido del segmento turista**; Given que el visitante del segmento turista solicita el contenido dirigido a su segmento; When el sistema procesa la solicitud; Then el sistema retorna información sobre las funcionalidades de seguridad y navegación offline orientadas al turista; **Escenario 2: Acceso al registro desde el segmento turista**; Given que el visitante del segmento turista solicita iniciar el registro; When el sistema procesa la solicitud; Then el sistema redirige al proceso de registro correspondiente al segmento turista; **Escenario 3: Contenido no disponible**; Given que ocurre un fallo al entregar el contenido del segmento turista; When el visitante solicita el contenido; Then el sistema retorna un mensaje indicando que el contenido no está disponible temporalmente | EP06 |
| US-LP04 | Conocer beneficios para agencias | Como visitante del segmento agencia, quiero conocer los beneficios específicos de la plataforma para comprender cómo mejora la gestión y monitoreo de expediciones. | **Escenario 1: Acceso al contenido del segmento agencia**; Given que el visitante del segmento agencia solicita el contenido dirigido a su segmento; When el sistema procesa la solicitud; Then el sistema retorna información sobre las funcionalidades de monitoreo, alertas y gestión de expediciones; **Escenario 2: Acceso al registro desde el segmento agencia**; Given que el visitante del segmento agencia solicita iniciar el registro; When el sistema procesa la solicitud; Then el sistema redirige al proceso de registro correspondiente al segmento agencia; **Escenario 3: Contenido no disponible**; Given que ocurre un fallo al entregar el contenido del segmento agencia; When el visitante solicita el contenido; Then el sistema retorna un mensaje indicando que el contenido no está disponible temporalmente | EP06 |
| US-LP05 | Conocer las funcionalidades principales | Como visitante, quiero conocer las funcionalidades principales de la plataforma para entender el funcionamiento general del sistema. | **Escenario 1: Acceso al contenido**; Given que el visitante solicita el contenido de funcionalidades principales; When el sistema procesa la solicitud; Then el sistema retorna información sobre las funcionalidades principales de VitalTrek; **Escenario 2: Acceso a funcionalidad offline**; Given que el visitante solicita información sobre la compatibilidad offline de la plataforma; When el sistema procesa la solicitud; Then el sistema retorna información sobre la operatividad sin conexión de forma clara; **Escenario 3: Contenido no disponible**; Given que ocurre un fallo al entregar el contenido de funcionalidades; When el visitante solicita la información; Then el sistema retorna un mensaje indicando que el contenido no está disponible temporalmente | EP06 |
| US-LP06 | Acceder al registro desde la landing | Como visitante, quiero acceder rápidamente al registro desde la landing page para comenzar a utilizar la plataforma. | **Escenario 1: Redirección al registro de turista**; Given que el visitante del segmento turista solicita iniciar el registro; When el sistema procesa la solicitud; Then el sistema redirige al proceso de registro del segmento turista; **Escenario 2: Redirección al registro de agencia**; Given que el visitante del segmento agencia solicita iniciar el registro; When el sistema procesa la solicitud; Then el sistema redirige al proceso de registro del segmento agencia; **Escenario 3: Servicio de registro no disponible**; Given que el servicio de registro no se encuentra disponible; When el visitante solicita iniciar el registro; Then el sistema retorna un mensaje indicando que el servicio no está disponible temporalmente | EP06 |
| US-LP07 | Conocer testimonios y casos de uso | Como visitante, quiero conocer testimonios y casos de uso reales para tomar una decisión informada sobre la plataforma. | **Escenario 1: Testimonios disponibles**; Given que el visitante solicita el contenido de testimonios; When el sistema procesa la solicitud; Then el sistema retorna los testimonios y casos de uso registrados; **Escenario 2: Sin testimonios disponibles**; Given que no existen testimonios registrados; When el visitante solicita el contenido; Then el sistema retorna un mensaje indicando que no hay testimonios disponibles por el momento; **Escenario 3: Contenido no disponible**; Given que ocurre un fallo al entregar el contenido de testimonios; When el visitante solicita la información; Then el sistema retorna un mensaje indicando que el contenido no está disponible temporalmente | EP06 |
| US-LP08 | Contactar al equipo de VitalTrek | Como visitante, quiero contactar al equipo de VitalTrek para resolver dudas relacionadas con la plataforma. | **Escenario 1: Mensaje enviado correctamente**; Given que el visitante proporciona información válida en el formulario de contacto; When envía la solicitud de contacto; Then el sistema registra el mensaje correctamente y retorna confirmación de recepción; **Escenario 2: Datos inválidos**; Given que el visitante ingresa información con formato incorrecto; When envía la solicitud de contacto; Then el sistema retorna un error indicando los campos con formato inválido; **Escenario 3: Servicio de contacto no disponible**; Given que el servicio de contacto no se encuentra disponible; When el visitante envía la solicitud; Then el sistema retorna un mensaje indicando que el servicio no está disponible temporalmente | EP06 |
| US-LP09 | Conocer al equipo de la startup | Como visitante, quiero conocer al equipo detrás de VitalTrek para construir confianza en la propuesta de valor. | **Escenario 1: Información del equipo disponible**; Given que el visitante solicita el contenido del equipo; When el sistema procesa la solicitud; Then el sistema retorna información sobre los miembros del equipo de NexumDevs; **Escenario 2: Acceso desde dispositivo móvil**; Given que el visitante accede al contenido del equipo desde un dispositivo móvil; When el sistema procesa la solicitud; Then el sistema retorna la información adaptada al tamaño del dispositivo; **Escenario 3: Contenido no disponible**; Given que ocurre un fallo al entregar el contenido del equipo; When el visitante solicita el contenido; Then el sistema retorna un mensaje indicando que el contenido no está disponible temporalmente | EP06 |
| US-LP10 | Acceder a una demostración del sistema | Como visitante, quiero acceder a una demostración del sistema para comprender el funcionamiento de la plataforma antes de registrarme. | **Escenario 1: Demostración disponible**; Given que el visitante solicita la demostración del sistema; When el sistema procesa la solicitud; Then el sistema provee acceso al recurso de demostración correctamente; **Escenario 2: Interacción con la demostración**; Given que el visitante interactúa con la demostración; When el sistema procesa cada interacción; Then el sistema responde correctamente a cada acción del visitante; **Escenario 3: Demostración no disponible**; Given que el recurso de demostración no se encuentra disponible; When el visitante solicita la demostración; Then el sistema retorna un mensaje indicando que el recurso no está disponible temporalmente | EP06 |
| **EP07** | **RESTful API** | Agrupa los endpoints RESTful que exponen las funcionalidades del sistema a los componentes del frontend y dispositivos IoT, siguiendo los estándares de diseño de API REST. | — | — |
| TS-IAM-01 | Endpoint de registro y autenticación | Como frontend developer, quiero registrar usuarios y validar credenciales mediante la API para poder crear cuentas y autenticarlas de forma segura en la plataforma. | **Escenario 1: Registro exitoso**; Given que el request contiene un body con información válida y completa; When el cliente consume el endpoint POST `/api/v1/users`; Then el sistema retorna una respuesta con código 201 y los datos del usuario creado; **Escenario 2: Autenticación exitosa**; Given que el request contiene credenciales válidas y registradas; When el cliente consume el endpoint POST `/api/v1/auth/login`; Then el sistema retorna una respuesta con código 200 y el token de acceso generado; **Escenario 3: Correo duplicado en registro**; Given que el correo del request ya existe en el sistema; When el cliente consume el endpoint POST `/api/v1/users`; Then el sistema retorna una respuesta con código 409 indicando que el recurso ya existe; **Escenario 4: Token expirado**; Given que el token de acceso del cliente ha superado su tiempo de validez; When el cliente consume un endpoint protegido; Then el sistema retorna una respuesta con código 401 indicando que el token no es válido | EP07 |
| TS-IAM-02 | Endpoint de vinculación de wearables | Como frontend developer, quiero vincular dispositivos wearable a las cuentas de los turistas mediante la API para que el sistema pueda mapear la telemetry entrante al usuario correcto. | **Escenario 1: Vinculación exitosa**; Given que el request contiene el `DeviceId`; When el cliente consume el endpoint POST `/api/v1/users/{userId}/wearables`; Then el sistema verifica la disponibilidad y retorna una respuesta con código 201; **Escenario 2: Dispositivo en uso**; Given que el `DeviceId` ya está vinculado a otra cuenta; When el cliente consume el endpoint; Then el sistema retorna una respuesta con código 409 indicando el conflicto | EP07 |
| TS-TM-03 | Endpoint de gestión de tours | Como frontend developer, quiero gestionar (crear, consultar, actualizar y eliminar) tours mediante la API para poder administrar el catálogo de la agencia en la interfaz. | **Escenario 1: Creación exitosa**; Given que el request contiene información válida del tour y un token de acceso válido; When el cliente consume el endpoint POST `/api/v1/tours`; Then el sistema retorna una respuesta con código 201 y los datos del tour creado; **Escenario 2: Consulta exitosa**; Given que existen tours registrados y el token es válido; When el cliente consume el endpoint GET `/api/v1/tours`; Then el sistema retorna una respuesta con código 200 y la lista de tours disponibles; **Escenario 3: Tour no encontrado**; Given que el identificador del tour solicitado no existe; When el cliente consume el endpoint GET `/api/v1/tours/{id}`; Then el sistema retorna una respuesta con código 404 indicando que el recurso no existe; **Escenario 4: Solicitud sin autorización**; Given que el request no contiene un token de acceso válido; When el cliente consume el endpoint; Then el sistema retorna una respuesta con código 401 indicando que se requiere autenticación | EP07 |
| TS-TM-04 | Endpoint de asignación de turistas | Como frontend developer, quiero asignar turistas a un tour específico mediante la API para que la agencia pueda gestionar los grupos de expedición desde la interfaz. | **Escenario 1: Asignación exitosa**; Given que el request contiene un `TouristId` válido; When el cliente consume el endpoint POST `/api/v1/tours/{tourId}/tourists`; Then el sistema retorna una respuesta con código 201 confirmando la asignación; **Escenario 2: Turista ya asignado**; Given que el turista ya pertenece al tour; When el cliente consume el endpoint; Then el sistema retorna una respuesta con código 409 indicando el conflicto | EP07 |
| TS-TO-05 | Endpoint de gestión de expediciones | Como frontend developer, quiero iniciar, consultar y finalizar expediciones mediante la API para gestionar el ciclo de vida de cada recorrido activo en la pantalla. | **Escenario 1: Inicio exitoso**; Given que el request contiene un `TourId` válido y credenciales de guía; When el cliente consume el endpoint POST `/api/v1/expeditions`; Then el sistema retorna una respuesta con código 201 y los datos de la expedición iniciada; **Escenario 2: Finalización exitosa**; Given que la expedición se encuentra en estado activo; When el cliente consume el endpoint PUT `/api/v1/expeditions/{id}/finish`; Then el sistema retorna una respuesta con código 200 confirmando el cierre | EP07 |
| TS-TO-06 | Endpoint de sincronización offline | Como frontend developer, quiero enviar datos almacenados localmente al recuperar conexión mediante la API para que no se pierdan registros generados durante la expedición offline. | **Escenario 1: Sincronización exitosa**; Given que el request contiene un array de eventos offline válidos; When el cliente consume el endpoint POST `/api/v1/expeditions/{id}/sync`; Then el sistema procesa los datos, aplica deduplicación y retorna código 200; **Escenario 2: Error de procesamiento**; Given que ocurre un fallo interno al procesar el payload; When el cliente consume el endpoint; Then el sistema retorna código 500 indicando fallo en la sincronización | EP07 |
| TS-MON-07 | Endpoint de ingesta de telemetry IoT | Como frontend developer, quiero enviar telemetría capturada por los dispositivos IoT mediante la API para habilitar el monitoreo biométrico y de ubicación en tiempo real en la interfaz. | **Escenario 1: Ingesta exitosa**; Given que el request contiene telemetry válida proveniente de un dispositivo registrado; When el cliente consume el endpoint POST `/api/v1/telemetry`; Then el sistema registra la data y retorna una respuesta con código 201; **Escenario 2: Dispositivo no autorizado**; Given que el `DeviceId` del payload no está registrado; When el cliente consume el endpoint; Then el sistema retorna código 403 Forbidden | EP07 |
| TS-MON-08 | Endpoint de gestión de incidentes | Como frontend developer, quiero registrar y consultar incidentes reportados en campo mediante la API para que el administrador de agencia pueda verlos y responder oportunamente. | **Escenario 1: Registro exitoso**; Given que el request contiene información válida de un incidente (severidad, coordenadas); When el cliente consume el endpoint POST `/api/v1/incidents`; Then el sistema registra el incidente, dispara alertas y retorna código 201; **Escenario 2: Consulta de incidentes**; Given que existen incidentes en la expedición; When el cliente consume el endpoint GET `/api/v1/expeditions/{id}/incidents`; Then el sistema retorna código 200 y el listado de incidentes | EP07 |
| TS-MON-09 | Endpoint de alertas automáticas | Como frontend developer, quiero obtener alertas generadas ante anomalías detectadas en la telemetry mediante la API para mostrarlas en el panel de supervisión de la expedición. | **Escenario 1: Generación de alerta**; Given que el sistema detecta valores biométricos o de ubicación fuera del umbral configurado; When el servicio interno procesa la regla; Then el sistema registra la alerta y notifica vía WebSockets o Push; **Escenario 2: Consulta de alertas activas**; Given que la expedición tiene alertas sin resolver; When el cliente consume el endpoint GET `/api/v1/expeditions/{id}/alerts`; Then el sistema retorna código 200 y el listado de alertas | EP07 |
| TS-NOT-10 | Endpoint de perfil y notificaciones | Como frontend developer, quiero gestionar el perfil del usuario y sus preferencias de notificaciones mediante la API para mantener actualizada la información de contacto y emergencia. | **Escenario 1: Actualización exitosa**; Given que el request contiene campos válidos como contactos de emergencia; When el cliente consume el endpoint PUT `/api/v1/profiles/{id}`; Then el sistema actualiza el registro y retorna código 200 con el `ProfileResource` actualizado; **Escenario 2: Datos de perfil inválidos**; Given que el request contiene formatos de email o teléfono inválidos; When el cliente consume el endpoint; Then el sistema retorna código 400 indicando los campos con error; **Escenario 3: Perfil no encontrado**; Given que se intenta actualizar un identificador de usuario que no existe; When el cliente consume el endpoint; Then el sistema retorna código 404 | EP07 |
| TS-DASH-11 | Endpoint de métricas de agencia (Dashboard) | Como frontend developer, quiero obtener métricas operativas globales mediante la API para renderizar el panel principal de analíticas del administrador de agencia. | **Escenario 1: Fetch exitoso**; Given que el request posee un token de administrador; When el cliente consume el endpoint GET `/api/v1/analytics/agency-dashboard`; Then el sistema agrega los datos y retorna código 200 con totales de expediciones activas, incidentes y turistas; **Escenario 2: Sin datos operativos**; Given que la agencia es nueva y no tiene expediciones registradas; When el cliente consume el endpoint; Then el sistema retorna código 200 con todos los contadores en cero; **Escenario 3: Rol no autorizado**; Given que el request posee un token de turista en lugar de administrador; When el cliente consume el endpoint; Then el sistema retorna código 403 Forbidden | EP07 |
| TS-DASH-12 | Endpoint de exportación de reportes | Como frontend developer, quiero generar reportes exportables de las expediciones mediante la API para permitir la descarga de auditorías y análisis de rendimiento en la vista. | **Escenario 1: Exportación CSV exitosa**; Given que el request solicita formato CSV de una expedición finalizada; When el cliente consume el endpoint GET `/api/v1/analytics/expeditions/{id}/export?format=csv`; Then el sistema compila la data y retorna código 200 con un file stream `text/csv`; **Escenario 2: Expedición sin finalizar**; Given que se solicita el reporte de una expedición que sigue activa; When el cliente consume el endpoint; Then el sistema retorna código 400 indicando que solo se exportan expediciones finalizadas; **Escenario 3: Formato no soportado**; Given que el request solicita un formato inválido en los query parameters; When el cliente consume el endpoint; Then el sistema retorna código 400 indicando los formatos válidos disponibles | EP07 |
...
![Navigation with home page](assets/images/wireframe-pantalla-1.png)

Pantalla 2:

![problem with turims](assets/images/wireframe-pantalla-2.png)

Pantalla 3:

![solution](assets/images/wireframe-pantalla-3.png)

Pantalla 4:

![IoT technology](assets/images/wireframe-pantalla-4.png)

Pantalla 5:

![key features](assets/images/wireframe-pantalla-5.png)

Pantalla 6:

![how it works](assets/images/wireframe-pantalla-6.png)

Pantalla 7:

![who we are](assets/images/wireframe-pantalla-7.png)

Pantalla 8:

![testimonials](assets/images/wireframe-pantalla-8.png)

Pantalla 9:

![form and footer](assets/images/wireframe-pantalla-9.png)
...
![Who we are](assets/images/mock-up-pantalla-6.png)
...
| VitalTrek-Project/vital-trek-platform | feature/engagement | 0228bac | feat(engagement): implement GET profile endpoint with base state handling | Se implementó el endpoint GET /api/v1/loyalty/profiles/{id} con manejo de perfil base para turistas sin historial de tours. | 16/06/2026 |
| VitalTrek-Project/vital-trek-platform | feature/engagement | 456316d1 | feat(engagement): implement POST award endpoint with duplicate and validation checks | Se implementó el endpoint POST /api/v1/loyalty/profiles/{id}/award con validaciones de duplicado y datos incorrectos. | 16/06/2026 |
| VitalTrek-Project/vital-trek-platform | feature/iot | c096f41 | feat(iot): add IoT REST controllers and DI registrations | Se agregaron los controladores REST del bounded context IoT (IoTDevicesController, SensorReadingsController) junto con sus resources y assemblers, además del registro de inyección de dependencias correspondiente. | 20/06/2026 |
